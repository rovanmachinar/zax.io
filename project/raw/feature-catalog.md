...
| Operator overloading | The shared model is owned by [Zax operators](../../language/operators.md), the cohesive word-spelled feature by [operator phrases](../../language/operator-phrases.md), exact forms by the [operator catalog](../../language/operator-catalog.md), tree-pattern behavior by [mixfix operators](../../language/mixfix-operators.md), and composition exposure by [Zax composition](../../language/composition.md); allocation uses a protected declaration-bound family, while literal, numeric-family, indexing, and pointer-mechanics remainder is routed to focused live inputs |
...
| Explicitly sized integers, floating points, enums, booleans, and strings | Current finite integer types are owned by [Zax integers](../../language/integers.md), bounded fixed-point formats by [fixed-point scalars](../../language/fixed-point-scalars.md), ordinary/profile/legacy binary floating formats by [floating-point scalars](../../language/floating-point-scalars.md), intrinsic byte order by [endianness](../../language/endianness.md), and enum behavior by [Zax enums](../../language/enums.md); unbounded/custom numeric mechanics remain in [numeric type families](numeric-type-families.md) |
