...
| Type composition with inner and outer casting | Current identity boundaries are owned by [Zax identity types](../../language/identity-types.md); general `own`, signature transformation, and same-storage representation-cast pressure is preserved in [owned composition](owned-composition.md) |
