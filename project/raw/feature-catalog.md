...
| Explicitly sized integers, floating points, enums, booleans, and strings | Current finite integer types, representations, role identities, conversions, and operation domains are owned by [Zax integers](../../language/integers.md); enum behavior by [Zax enums](../../language/enums.md); floating, fixed-point, unbounded, and deferred numeric mechanics remain in [numeric type families](numeric-type-families.md) |
| Enums with underlying types | Current enum identity, members, admission, operations, flags, and string behavior are owned by [Zax enums](../../language/enums.md); exact generated forms by the [operator catalog](../../language/operator-catalog.md); and endian semantics by [Zax endianness](../../language/endianness.md) |
