...
| Direct type casting | Current integer conversion is owned by [Zax integers](../../language/integers.md) and the [integer operator catalog](../../language/integer-operator-catalog.md); outer casting is owned by [Zax composition](../../language/composition.md); same-storage identity views remain in [identity types](../../language/identity-types.md) with structural constraints in [structural typing](structural-typing.md); remaining general casting stays legacy/future casting work |
...
| Safe conversion using `as` | Current integer exact/optional/narrowing conversion is taught by [Zax integers](../../language/integers.md#integer-identity-types), complete protected behavior by the [integer operator catalog](../../language/integer-operator-catalog.md#integer-conversion-and-admission), identity projection/admission by [Zax identity types](../../language/identity-types.md), and exact forms by the [operator catalog](../../language/operator-catalog.md#conversion-and-admission-forms); complete non-integer casting remains future work |
...
| Type composition with inner and outer casting | Current named containment, independent `own`, `preferred`, and `expose`, fulfillment, and immediate outer casting are owned by [Zax composition](../../language/composition.md); identity boundaries remain with [Zax identity types](../../language/identity-types.md); structural equivalence and same-storage identity views remain future work |
