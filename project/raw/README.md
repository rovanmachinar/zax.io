...
| [Bare source enclosure](bare-source.md) | Operator phrases, keyword-neutral source, confusable-form intent, transparent source enclosures, or source reflection is reviewed | Move accepted behavior into source, phrase, terminology, flow, and operator owners, then retire |
...
| [Function composition and chaining](function-composition-and-chaining.md) | Function composition, chaining, captures, lambda/generated callable types, callable generics, or reflection is reviewed | Move accepted behavior into function, invocation, operator, generic, or reflection owners, then retire |
...
| [Literals and literal operators](literal-operators.md) | Literal parsing, prefixes, realization, custom literals, or compile-time literal execution is reviewed | Move accepted behavior into literal, numeric, source, or operator owners, then retire |
...
| [Numeric type families](numeric-type-families.md) | Signedness, fixed-point, arbitrary-width, enum, alias, float, representation, or generic numeric behavior is reviewed | Move accepted behavior into numeric, type, cast, enum, or operator owners, then retire |
| [Partial type extensions](partial-types.md) | Partial/open types, extension methods, mixins, or external type completion is reviewed | Move accepted behavior into type, import, layout, and operator owners, then retire |
