...
| [Literals and literal operators](literal-operators.md) | Literal parsing, prefixes, realization, custom literals, juxtaposition, or compile-time literal execution is reviewed | Move accepted behavior into literal, numeric, source, or operator owners, then retire |
...
| [Numeric type families](numeric-type-families.md) | Signedness, fixed-point, arbitrary-width, canonical bit-count type, reversal, extraction/deposit, multiword numeric behavior, alias, float, representation, or generic numeric behavior is reviewed | Move accepted behavior into numeric, type, cast, or operator owners, then retire |
| [Partial type extensions](partial-types.md) | Partial/open types, extension methods, mixins, external phrase or mixfix extensions, or external type completion is reviewed | Move accepted behavior into type, import, layout, and operator owners, then retire |
