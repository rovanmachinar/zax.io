...
| [Lifetime strategies](lifetimes.md) | Pointer/lifetime policy, reference origin, independent pointer/reference binding replacement or rebinding, replacement aliasing, pointer preservation, `lease`, terminal capabilities, or pointer/pointee transfer is reviewed | Consume through a subject-specific work item |
