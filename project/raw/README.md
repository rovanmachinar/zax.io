...
| --- | --- | --- |
| [Analysis controls](analysis-controls.md) | Unsafe semantic permissions/assertions, static-analysis contracts, lifetime/replacement proof, language/compiler/community provenance, or lint suppression is designed | Move semantic guarantees and source controls into safety, diagnostics, tooling, or contract owners, then retire the input |
| [Asynchronous execution](async.md) | Async language documentation, suspending transfer/cancellation, cross-thread value preparation, or lowering/runtime design begins | Consume through a subject-specific work item |
| [Bare source enclosure](bare-source.md) | Keyword-neutral source, transparent source enclosures, or source reflection is reviewed | Move accepted behavior into source, terminology, flow, and operator owners, then retire |
...
| [Callable selection](callable-selection.md) | Callable preference, exact-prototype aliases, qualifier/stance comparison, generic specialization, generated-candidate ambiguity, or `own` surface selection is reviewed | Move accepted behavior into invocation, declaration, generic, composition, and reflection owners, then retire |
...
| [Pointer and arena mechanics](pointer-and-arena-mechanics.md) | Complete pointer/allocation syntax, failure operators, custom arenas or control blocks, deeper/unsafe anchoring, provenance, pointer casts, pointer-layer presence mechanics, cycle tracing, storage recovery, prompt-disposition constraints, or thread-affine release is reviewed | Move accepted behavior into pointer, allocation, concurrency, safety, and applicable domain owners, then retire |
...
| [Nothing instances](nothing-instances.md) | Real global `Nothing` instances, monitored member access, generated `_` checks, custom `Nothing`, compatible sentinel storage, or pointer-`Nothing` representation is reviewed | Move accepted behavior into type, pointer, lifetime, construction, safety, concurrency, and representation owners, then retire |
| [Owned composition and exposed identity surfaces](owned-composition.md) | `own`, identity-aware exposure, exact transfer/qualifier specialization, signature substitution, same-storage identity views, representation casts, composition sugar, or filtering is reviewed | Move accepted behavior into composition, type, identity, declaration, operator, layout, lifetime, casting, and reflection owners, then retire |
...
| [Reflection](reflection.md) | Reflection, type or declaration metadata, generated/qualifier-generic specialization identity, source reflection, or reflection-dependent tooling is reviewed | Move accepted behavior into a reflection owner and the domain owners whose facts it exposes, then retire |
| [Safety boundaries](safety.md) | Public guarantees, transfer-contract blame, construction lifecycle diagnostics, manual lifecycle safety, panic behavior, or unsafe boundaries are designed | Consume through a subject-specific work item |
...
| [Type parameters and generics](type-parameters-and-generics.md) | Generics, qualifier parameters, dependent result qualification, type parameters, constraints, computed type results, type-receiver identity, exact specialization, or generated type families are reviewed | Move accepted behavior into generic, declaration, invocation, type, and reflection owners, then retire |
